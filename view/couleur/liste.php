...
<div class="container" style="margin-top: 90px; width: 800px">
    <div class="panel panel-info ">
        <div class="panel-heading" align="center">Mes Couleurs</div>
        <div class="panel-body" style="padding-left: auto;">
            ...
            <table id="example" class="ui celled table" style="width:100%; margin-left: auto; ">
                ...
                <tbody>
                <?php
                while($result=mysqli_fetch_row($couleur))
                {
                    echo "
                    <tr>
                        <td style='text-align:center;'>$result[1]</td>
                        <td><center><a class='btn btn-info btn-xs' href='?page=couleur/edit&id=$result[0]'>Éditer</a></center></td>
                        <td><center><a class='btn btn-danger btn-xs' href='?page=couleur/delete&id=$result[0]'>Supprimer</a></center></td>
                    </tr>
                    ";
                }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="exampleModalLabel" align="center">Nouveau couleur</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="post" action="<?php echo base_url(); ?>controller/CouleurController.php">
